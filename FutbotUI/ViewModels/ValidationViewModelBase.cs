...
namespace FutbotUI.ViewModels
{
    ...
    public class ValidationViewModelBase : ViewModelBase, IDataErrorInfo, IValidationExceptionHandler
    {
        ...
        /// <summary>
        /// test prevent infinite loop while settings IsValid (which causes an PropertyChanged to be raised)    
        /// </summary>
        protected override void PropertyChangedCompleted()
        {                       
